...
void SlidingMenuGrid::showPagesIndicator(bool isShowPagesIndicator)
{
  isShowPagesIndicator = true;
  if (isShowPagesIndicator)
  {
    ...
    CCPoint m_tPagesIndicatorPosition = ccp(screenSize.width/2, screenSize.height/3);
    ...
    ccDrawPoint(points[getCurrentPage()]);
    CCLog("currentpage = %d", getCurrentPage());
